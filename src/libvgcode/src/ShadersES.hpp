...
"    // For near-vertical segments, read the parallel-transported frame angle\n"
"    // per-endpoint from the 4th texture component.  Both sides of each junction\n"
"    // read from the shared vertex, so faces align seamlessly.\n"
"    int frame_id = vertex_id < 4 ? id_a : id_b;\n"
"    float theta = texelFetch(height_width_angle_tex, tex_coord(height_width_angle_tex, frame_id), 0).w;\n"
