...
"uniform sampler2D coextrusion_centers_tex;\n"
"uniform sampler2D coextrusion_widths_tex;\n"
"uniform sampler2D coextrusion_colors_tex;\n"
"uniform bool coextrusion_preview_enabled;\n"
"in float vertex_id_float;\n"
"out vec3 fallback_color;\n"
"out float light_intensity;\n"
"out vec2 section_coord;\n"
"out vec4 coextrusion_centers;\n"
"out vec4 coextrusion_widths;\n"
"out vec4 coextrusion_colors;\n"
"out float coextrusion_enabled;\n"
...
"  section_coord = vec2(horizontal_sign, vertical_sign);\n"
...
"  fallback_color = decode_color(texelFetch(color_tex, tex_coord(color_tex, id), 0).r);\n"
"  light_intensity = lighting(eye_position, eye_normal);\n"
"  coextrusion_centers = vec4(0.0);\n"
"  coextrusion_widths = vec4(0.0);\n"
"  coextrusion_colors = vec4(0.0);\n"
"  coextrusion_enabled = 0.0;\n"
"  if (coextrusion_preview_enabled) {\n"
"    coextrusion_centers = texelFetch(coextrusion_centers_tex, tex_coord(coextrusion_centers_tex, id), 0);\n"
"    coextrusion_widths = texelFetch(coextrusion_widths_tex, tex_coord(coextrusion_widths_tex, id), 0);\n"
"    coextrusion_colors = texelFetch(coextrusion_colors_tex, tex_coord(coextrusion_colors_tex, id), 0);\n"
"    coextrusion_enabled = coextrusion_widths.x > 0.0 ? 1.0 : 0.0;\n"
"  }\n"
...
"in vec3 fallback_color;\n"
"in float light_intensity;\n"
"in vec2 section_coord;\n"
"in vec4 coextrusion_centers;\n"
"in vec4 coextrusion_widths;\n"
"in vec4 coextrusion_colors;\n"
"in float coextrusion_enabled;\n"
"out vec4 fragment_color;\n"
"vec3 decode_color(float color) {\n"
"  int c = int(round(color));\n"
"  return vec3(float((c >> 16) & 0xFF), float((c >> 8) & 0xFF), float(c & 0xFF)) / 255.0;\n"
"}\n"
"float angle_distance(float a, float b) {\n"
"  return abs(mod(a - b + 540.0, 360.0) - 180.0);\n"
"}\n"
"void main() {\n"
"  vec3 color_base = fallback_color;\n"
"  if (coextrusion_enabled > 0.5) {\n"
"    float angle = degrees(atan(section_coord.y, section_coord.x));\n"
"    for (int i = 0; i < 4; ++i) {\n"
"      if (coextrusion_widths[i] > 0.0 && angle_distance(angle, coextrusion_centers[i]) <= 0.5 * coextrusion_widths[i]) {\n"
"        color_base = decode_color(coextrusion_colors[i]);\n"
"        break;\n"
"      }\n"
"    }\n"
"  }\n"
"  fragment_color = vec4(color_base * light_intensity, 1.0);\n"
"}\n";
