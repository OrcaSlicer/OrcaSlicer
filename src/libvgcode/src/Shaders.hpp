...
"uniform samplerBuffer coextrusion_centers_tex;\n"
"uniform samplerBuffer coextrusion_widths_tex;\n"
"uniform samplerBuffer coextrusion_colors_tex;\n"
...
"  fallback_color = decode_color(texelFetch(color_tex, id).r);\n"
...
"    coextrusion_centers = texelFetch(coextrusion_centers_tex, id);\n"
"    coextrusion_widths = texelFetch(coextrusion_widths_tex, id);\n"
"    coextrusion_colors = texelFetch(coextrusion_colors_tex, id);\n"
