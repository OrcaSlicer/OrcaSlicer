...
// ---------------------------------------------------------------------------
// JSON -> SliceRequest mapping
//
// Field mapping per the spec:
//   presets.{printer, process, filaments[], load_settings[], load_filaments[]}
//   plate
//   transforms.{arrange, orient, rotate, scale, repetitions, skip_objects[]}
//   output.{mode, outputdir, host{}, start_print}
//   export.kind
// ---------------------------------------------------------------------------
