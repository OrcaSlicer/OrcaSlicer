                ...
                En3mfType          en_3mf_file_type = En3mfType::From_BBS;
                {
                    ...
                    if (en_3mf_file_type == En3mfType::From_Prusa) {
                        ...
                        if (file_version < orca_tag_start_version) {
                            // Compatible old version (before OrcaSlicer tagging was introduced in 2.3.2).
                            // Any version prior to 2.3.2 is older than the current one, no version warnings needed.
