                ...
                En3mfType          en_3mf_file_type = En3mfType::From_BBS;
                {
                    ...
                    if (en_3mf_file_type == En3mfType::From_Prusa) {
                        ...
                        if (load_type != LoadType::LoadGeometry)
                            log_and_show_3mf_info(_L("The 3MF is not supported by OrcaSlicer, loading geometry data only."), _L("Load 3MF"));
                    }
                        ...
                        if (load_config && (file_version < app_version) && file_version == Semver("2.3.1-alpha")) {
                            ...
                            if (config_substitutions.unrecogized_keys.size() > 0) {
                                ...
                                context += "\n\n";
                                context += append;
                                log_and_show_3mf_info(context, _L("Newer 3MF version"));
                            }
                            else {
                                ...
                                if (file_version.min() != app_version.min()) {
                                    wxString text  = wxString::Format(_L("The 3MF file version %s is newer than %s's version %s, we suggest to upgrade your software."),
                                                     file_version.to_string_sf(), std::string(SLIC3R_APP_FULL_NAME), app_version.to_string_sf());
                                    text += "\n";
                                    log_and_show_3mf_info(text, _L("Newer 3MF version"));
                                }
                            }
                        }
                        else if (load_config && config_loaded.empty()) {
                            load_config = false;
                            log_and_show_3mf_info(_L("The 3MF file was generated by an old OrcaSlicer version, loading geometry data only."), _L("Load 3MF"));
                        }
                    }
                        ...
                        if (file_version <= orca_tag_start_version) {
                            ...
                            if (load_config && (file_version == Semver("2.3.1-alpha"))) {
                                ...
                                load_config = false;
                                log_and_show_3mf_info(_L("The 3MF file was generated by an older version, loading geometry data only."), _L("Load 3MF"));
                            }
                        } else {
                            ...
                            if (load_config && config_loaded.empty()) {
                                load_config = false;
                                log_and_show_3mf_info(_L("The 3MF file was generated by BambuStudio, loading geometry data only."), _L("Load 3MF"));
                            }
                                ...
                                if (config_substitutions.unrecogized_keys.size() > 0) {
                                    ...
                                    context += "\n\n";
                                    context += append;
                                    log_and_show_3mf_info(context, _L("BambuStudio Project"));
                                } else {
                                    wxString text  = wxString::Format(_L("The 3MF was created by BambuStudio (version %s), which is newer than the compatible version %s. Some settings may not be fully compatible."),
                                                     file_version.to_string(), slic3r_version.to_string());
                                    text += "\n";
                                    log_and_show_3mf_info(text, _L("BambuStudio Project"));
                                }
                            } else if (load_config) {
