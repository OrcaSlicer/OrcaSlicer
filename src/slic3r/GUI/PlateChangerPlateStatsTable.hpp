...
// Per-plate time/weight always reflect slice stats; unchecked rows show them dimmed. Totals exclude unchecked plates.
// `plate_included[i]` is true when plate i is in the job.
