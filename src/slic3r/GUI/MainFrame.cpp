...
#else // _WIN32
    return wxIcon(Slic3r::var("ExtremeSlicer.ico"), wxBITMAP_TYPE_ICO);
#endif // _WIN32
}
...
*/
    ...
    case GUI_App::EAppMode::Editor:
        ...
        m_taskbar_icon->SetIcon(wxIcon(Slic3r::var("ExtremeSlicer.ico"), wxBITMAP_TYPE_ICO), "Extreme Slicer");
        break;
...
#else
    SetIcon(wxIcon(var("ExtremeSlicer.ico"), wxBITMAP_TYPE_ICO));
#endif // _WIN32
