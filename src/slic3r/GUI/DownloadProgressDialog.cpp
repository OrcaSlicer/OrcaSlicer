    ...
    : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, title, wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    wxString install_failed_msg = _L("Failed to install the plug-in. The plug-in file may be in use. Please restart Extreme Slicer and try again. Also check whether it is blocked or has been deleted by anti-virus software.");
