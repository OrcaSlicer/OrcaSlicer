...
std::map<std::string, std::vector<SimpleSettingData>>  SettingsFactory::OBJECT_CATEGORY_SETTINGS=
{
    { L("Quality"), {{"layer_height", "",1},
                    ...
                    {"seam_position", "",2},
                    {"random_seam_corner_clearance", "",3}, {"random_seam_corner_angle", "",4},
                    {"random_seam_min_wall_depth", "",5}, {"random_seam_min_distance", "",6},
                    {"slice_closing_radius", "",7}, {"resolution", "",8},
                    {"xy_hole_compensation", "",9}, {"xy_contour_compensation", "",10}, {"elefant_foot_compensation", "",11},
                    {"make_overhang_printable_angle","", 12},{"make_overhang_printable_hole_size","",13}, {"wall_sequence","",14},
                    {"precise_z_height", "",15}
                    }},
