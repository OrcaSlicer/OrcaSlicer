...
wxBoxSizer* NetworkTestDialog::create_info_sizer(wxWindow* parent)
{
	...
	text_version_title = new wxStaticText(this, wxID_ANY, _L("Extreme Slicer Version:"), wxDefaultPosition, wxDefaultSize, 0);
...
wxBoxSizer* NetworkTestDialog::create_content_sizer(wxWindow* parent)
{
	...
	btn_link = new Button(this, _L("Test Extreme Slicer (GitHub)"));
    btn_link->SetStyle(ButtonStyle::Regular, ButtonType::Window);
	grid_sizer->Add(btn_link, 0, wxEXPAND | wxALL, 5);

	text_link_title = new wxStaticText(this, wxID_ANY, _L("Test Extreme Slicer (GitHub):"), wxDefaultPosition, wxDefaultSize, 0);
