...
: wxDialog(nullptr, wxID_ANY, _L("SLA gizmo keyboard shortcuts"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER)
{
    ...
    shortcuts.push_back(std::make_pair(_CTX("Enter", "Keyboard Shortcut"),                   _L("Apply changes")));
    shortcuts.push_back(std::make_pair(_CTX("Esc", "Keyboard Shortcut"),                     _L("Discard changes")));
