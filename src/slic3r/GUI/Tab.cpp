...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Multimaterial"), "custom-gcode_multi_material"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("surface_wall_override_filament", "multimaterial_settings_filament_for_features#surface--outer-wall-override");
        optgroup->append_single_option_line("outer_wall_count", "multimaterial_settings_filament_for_features#outer-wall-count");
        optgroup->append_single_option_line("surface_wall_override_filament_target", "multimaterial_settings_filament_for_features#apply-to");
