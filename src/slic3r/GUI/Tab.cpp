...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Strength"), "custom-gcode_strength"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("top_surface_fill_order", "strength_settings_top_bottom_shells#surface-pattern");
        ...
        optgroup->append_single_option_line("bottom_surface_fill_order", "strength_settings_top_bottom_shells#surface-pattern");
