...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Multimaterial"), "custom-gcode_multi_material"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("wall_filament_id", "multimaterial_settings_filament_for_features#walls");
        optgroup->append_single_option_line("sparse_infill_filament_id", "multimaterial_settings_filament_for_features#infill");
        optgroup->append_single_option_line("solid_infill_filament_id", "multimaterial_settings_filament_for_features#solid-infill");
