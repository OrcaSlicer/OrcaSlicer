...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Strength"), "custom-gcode_strength"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("lightning_overhang_angle");
        optgroup->append_single_option_line("lightning_prune_angle");
        optgroup->append_single_option_line("lightning_straightening_angle");
