...
// Orca: we use a different logic here. If SEMM is enabled, we set extruder count to 1.
        ...
        optgroup->append_single_option_line("always_travel_to_wipe_tower", "printer_multimaterial_wipe_tower#always-travel-to-wipe-tower");
...
void TabPrinter::toggle_options()
{
    ...
    if (m_active_page->title() == L("Multimaterial")) {
        ...
        // Orca: "Always travel to wipe tower" only makes sense for multi-extruder (multi-toolhead) printers
        ...
        toggle_option("always_travel_to_wipe_tower", !bSEMM && supports_wipe_tower_2 && extruders_count > 1);
    }
