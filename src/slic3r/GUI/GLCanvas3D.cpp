...
{
    wxGetApp().plater()->get_partplate_list().render(view_matrix, projection_matrix, viewport, bottom, only_current, only_body, hover_id, render_cali, show_grid, !m_plate_chrome_enabled, false, -1);
}
