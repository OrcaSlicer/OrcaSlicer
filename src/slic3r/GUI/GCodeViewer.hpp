...
public:
    ...
    // ORCA: realistic view. Tone applied to the shaded toolpaths, paying back the light the
    // lighting term, the shadow and the SSAO pass each take off. 1.0/1.0 is a no-op.
