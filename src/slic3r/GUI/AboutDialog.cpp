    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, "ExtremeSlicer_about", 192);
...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("Extreme Slicer is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("Extreme Slicer is based on PrusaSlicer, Bambu Studio and the OrcaSlicer project"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, is_dark ? "ExtremeSlicer_about_dark" : "ExtremeSlicer_about", 125);
    ...
    text_list.push_back(_L("Extreme Slicer continues that open-source tradition with GPU-assisted slicing, CUDA/Vulkan backends and exact CPU fallbacks for topology-sensitive operations."));
    text_list.push_back(_L("This fork preserves the upstream Slic3r, PrusaSlicer, Bambu Studio and OrcaSlicer attributions while providing an independent Extreme Slicer user interface."));
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "Copyright(C) 2026 Extreme Slicer contributors", wxDefaultPosition, wxDefaultSize);
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_NEVER /*NEVER*/);
      {
          ...
          const auto text = from_u8(
              ...
              "<p style=\"text-align:left\"><a style=\"color:#009789\" href=\"https://github.com/mk0000001/Extreme-Slicer\">github.com/mk0000001/Extreme-Slicer</a></p>"
              "</body>"
              "</html>")
            ).str());
          m_html->SetPage(text);
