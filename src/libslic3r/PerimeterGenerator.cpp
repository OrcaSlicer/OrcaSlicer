...
void PerimeterGenerator::split_top_surfaces(const ExPolygons &orig_polygons, ExPolygons &top_fills,
    ...
    auto nozzle_diameter = this->print_config->nozzle_diameter.get_at(this->config->wall_filament_id - 1);
...
void PerimeterGenerator::process_classic()
{
    ...
    if (this->lower_slices != nullptr && this->config->detect_overhang_wall) {
        ...
        double nozzle_diameter = this->print_config->nozzle_diameter.get_at(this->config->wall_filament_id - 1);
...
{
    float nozzle_diameter = print_config->nozzle_diameter.get_at(config->wall_filament_id - 1);
