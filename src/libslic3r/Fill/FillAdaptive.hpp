...
// Multiline infill: lines of the three families to non-crossing paths d1 apart, running along the family sweep.
Polylines                       multiline_paths(const Lines &lines, double d1, int sweep, const BoundingBox &cover);
