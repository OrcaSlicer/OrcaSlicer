...
TemperaturesConfigDef::TemperaturesConfigDef()
{
    ...
    new_def("bed_temperature_single", coInt, "Bed temperature (initial extruder)", "Bed temperature for layers after the first layer, for the initial extruder. Same as bed_temperature[initial_extruder]")
