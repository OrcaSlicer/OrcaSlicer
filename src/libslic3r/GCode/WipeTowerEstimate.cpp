...
WipeTowerFootprint estimate_wipe_tower_footprint(const ConfigBase &config, WipeTowerType tower_type, const std::vector<unsigned int> &filament_ids, double layer_height, double max_object_height, bool any_raft)
{
    ...
    const bool   need_wipe_tower  = smooth_timelapse || wrapping || any_raft;
