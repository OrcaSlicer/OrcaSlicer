...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    // Orca / CN3D: Volumetric Temperature Compensation (VTC). Per-filament flow->temp
    // mapping; per-extruder thermal model. Concept: Nadir @ CN3D.
    ((ConfigOptionBools,               vtc_enabled))
    ((ConfigOptionFloats,              vtc_slope_k))
    ((ConfigOptionFloats,              vtc_ref_flow))
    ((ConfigOptionFloats,              vtc_max_delta))
    ((ConfigOptionFloats,              vtc_min_delta))
    ((ConfigOptionStrings,             vtc_flow_mode))
    ((ConfigOptionStrings,             vtc_flow_curve))
    ((ConfigOptionFloats,              vtc_lookahead_s))
    ((ConfigOptionFloats,              vtc_smoothing_s))
    ((ConfigOptionFloats,              vtc_min_cmd_interval_s))
    ((ConfigOptionFloats,              vtc_micro_adjust_interval_s))
    ((ConfigOptionFloats,              vtc_heating_rate))
    ((ConfigOptionFloats,              vtc_cooling_no_flow_rate))
    ((ConfigOptionFloats,              vtc_cooling_flow_rate))
    ((ConfigOptionFloats,              vtc_pid_overshoot))
    ((ConfigOptionFloats,              vtc_settling_margin_s))
    //
