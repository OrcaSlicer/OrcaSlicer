...
enum PrintHostType {
    htPrusaLink, htPrusaConnect, htOctoPrint, htUltimaker, htDuet, htFlashAir, htAstroBox, htRepetier, htMKS, htESP3D, htCrealityPrint, htObico, htFlashforge, htSimplyPrint, htElegooLink
};
