...
// Only add a newline in case the current G-code does not end with a newline.
                                                  ...
                                                  double                             z) const
    {
        ...
        // Orca: user-facing override (Printer Settings > Wipe tower > "Always travel to wipe tower").
        ...
        const bool always_travel_to_wipe_tower = gcodegen.config().always_travel_to_wipe_tower.value;
