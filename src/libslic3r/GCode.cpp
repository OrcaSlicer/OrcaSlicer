...
{
    // Pure math lives in calib_interpolate_value() so it can be unit-tested without a GCode instance.
    return calib_interpolate_value(start_value, end_value, step, m_layer_index, m_layer_count);
}
