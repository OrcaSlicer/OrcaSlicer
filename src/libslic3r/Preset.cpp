...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "silent_mode",
    "scan_first_layer", "enable_power_loss_recovery", "wrapping_detection_layers", "wrapping_exclude_area", "machine_load_filament_time", "machine_unload_filament_time", "machine_tool_change_time", "time_cost", "printer_power_watts", "electricity_rate", "printer_purchase_price", "printer_lifetime_hours", "maintenance_cost_per_hour", "fixed_cost_per_print", "profit_margin_percent", "tax_percent", "failure_rate_percent", "electricity_rate_night", "night_start_hour", "night_end_hour", "print_start_hour", "machine_pause_gcode", "template_custom_gcode",
