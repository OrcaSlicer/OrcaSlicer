...
static std::vector<std::string> s_Preset_print_options {
    ...
    "flush_into_infill", "flush_into_objects", "flush_into_support",
     ...
     // Z-Pinning
     "enable_z_pins", "z_pin_spacing", "z_pin_depth", "z_pin_diameter", "z_pin_fill_pct", "z_pin_feedrate", "z_pin_stagger", "z_pin_layer_stagger", "z_pin_layer_stagger_offset", "z_pin_style",
};
