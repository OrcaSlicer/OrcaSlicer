...
// BBL-port alias: BBL's class is named NozzleGroupResultBase. Orca's is MultiNozzleGroupResult.
using NozzleGroupResultBase = MultiNozzleGroupResult;
...
public:
    ...
    // BBL-port shim: alias for get_nozzle_vec.
    ...
    // BBL-port shim: BBL returns a vector of nozzles per filament (rack support); Orca's single
    // nozzle is wrapped into a vector here.
