...
#define SLIC3R_APP_FULL_NAME "Extreme Slicer"
#define GCODEVIEWER_APP_NAME "Extreme Slicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "ExtremeSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("Extreme Slicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
