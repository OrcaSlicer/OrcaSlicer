...
cp -a %{_builddir}/package/bin/. %{buildroot}%{install_dir}/bin/

# Resources
install -d %{buildroot}%{install_dir}/resources
cp -a %{_builddir}/package/resources/. %{buildroot}%{install_dir}/resources/
...
# Desktop entry
install -Dm644 %{_builddir}/src/dev-utils/platform/unix/OrcaSlicer.desktop \
    %{buildroot}%{_datadir}/applications/OrcaSlicer.desktop

# Icons (multiple sizes)
install -Dm644 %{_builddir}/resources/images/OrcaSlicer_192px.png \
    %{buildroot}%{_datadir}/icons/hicolor/192x192/apps/OrcaSlicer.png
install -Dm644 %{_builddir}/resources/images/OrcaSlicer_128px.png \
    %{buildroot}%{_datadir}/icons/hicolor/128x128/apps/OrcaSlicer.png
install -Dm644 %{_builddir}/resources/images/OrcaSlicer_64.png \
    %{buildroot}%{_datadir}/icons/hicolor/64x64/apps/OrcaSlicer.png
install -Dm644 %{_builddir}/resources/images/OrcaSlicer_32px.png \
