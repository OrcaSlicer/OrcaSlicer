@echo off
REM Wrapper to build OrcaSlicer with VS2022 Community and CMake even if they are not on PATH.
REM It sets up the VS developer environment and then delegates to build_release_vs2022.bat.
...
REM --- Run the existing VS2022 build script from the repo root ---
