...
if (MSVC)
    ...
    ExternalProject_Add(dep_GMP
        ...
        BUILD_IN_SOURCE ON
        CONFIGURE_COMMAND  env "CC=${DEP_CC}" "CXX=${DEP_CXX}" "CFLAGS=${_gmp_ccflags}" "CXXFLAGS=${_gmp_ccflags}" "LDFLAGS=${CMAKE_EXE_LINKER_FLAGS}" ./configure ${_cross_compile_arg} --enable-shared=no --enable-cxx=yes --enable-static=yes "--prefix=${DESTDIR}" ${_gmp_build_tgt}
