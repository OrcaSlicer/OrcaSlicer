...
if (MSVC)
    ...
    ExternalProject_Add(dep_MPFR
        ...
        CONFIGURE_COMMAND autoreconf -f -i && 
                          env "CC=${DEP_CC}" "CXX=${DEP_CXX}" "CFLAGS=${_gmp_ccflags}" "CXXFLAGS=${_gmp_ccflags}" "LDFLAGS=${CMAKE_EXE_LINKER_FLAGS}" ./configure ${_cross_compile_arg} --prefix=${DESTDIR} --enable-shared=no --enable-static=yes --with-gmp=${DESTDIR} ${_gmp_build_tgt}
