var LangText = {
  en: {
    t1: "Welcome to IEMAI 3D Slicer",
    t2: "IEMAI 3D Slicer will be setup in several steps. Let's start!",
    t3: "User Agreement",
    t4: "Disagree",
    t5: "Agree",
    ...
    t52: "Skip",
    t53: "Join",
    t54: "In the 3D Printing community, we learn from each other's successes and failures to adjust our own slicing parameters and settings. IEMAI 3D Slicer follows the same principle and uses machine learning to improve its performance from the successes and failures of the vast number of prints by our users. We are training IEMAI 3D Slicer to be smarter by feeding them the real-world data. If you are willing, this service will access information from your error logs and usage logs, which may include information described in ",
    t55: "Privacy Policy",
    ...
    t65: "Please be aware that these plugins are not developed or maintained by IEMAI 3D Slicer. They should be used at your own discretion and risk.",
    ...
    t83: "2, Close all open IEMAI 3D Slicer",
    t84: "3, Delete all files under the plug-in directory",
    t85: "4, Reopen IEMAI 3D Slicer and install the plug-in again",
    t86: "Close",
    t87: "User Manual",
    t88: "Remove",
  ...
  ca_ES: {
    t1: "Benvingut a IEMAI 3D Slicer",
    t2: "IEMAI 3D Slicer es configurarà en diversos passos. Comencem!",
    ...
    t52: "Saltar",
    t53: "Unir-se",
    t54: "A la comunitat d'Impressió 3D, aprenem dels èxits i fracassos dels altres per ajustar els nostres propis paràmetres i configuracions de laminació. IEMAI 3D Slicer segueix el mateix principi i utilitza l'aprenentatge automàtic per millorar el seu rendiment a partir dels èxits i fracassos d'un gran nombre d'impressions dels nostres usuaris. Estem entrenant IEMAI 3D Slicer per ser més intel·ligent alimentant-lo amb dades del món real. Si estàs disposat, aquest servei accedirà a informació dels teus registres d'errors i registres d'ús, que poden incloure informació descrita a la ",
    ...
    t65: "Tingues en compte que aquests connectors no són desenvolupats ni mantinguts per IEMAI 3D Slicer. S'han d'utilitzar a la teva discreció i risc.",
    ...
    t83: "2, Tanca totes les IEMAI 3D Slicer obertes",
    t84: "3, Elimina tots els fitxers del directori de connectors",
    t85: "4, Reobre IEMAI 3D Slicer i instal·la el connector de nou",
    t86: "Tancar",
  ...
  es_ES: {
    t1: "Bienvenido a IEMAI 3D Slicer",
    t2: "IEMAI 3D Slicer se configurará mediante varios pasos. ¡Comencemos!",
    t3: "Términos de uso",
    t4: "No acepto",
    t5: "Acepto",
    ...
    t52: "Omitir",
    t53: "Unirse",
    t54: "En la comunidad de impresión 3D aprendemos de los éxitos y fracasos de los demás para ajustar nuestros propios parámetros y configuraciones de corte. IEMAI 3D Slicer sigue el mismo principio y utiliza el aprendizaje automático para mejorar su rendimiento a partir de los éxitos y fallos del gran número de impresiones realizadas por nuestros usuarios. Estamos entrenando a IEMAI 3D Slicer para que sea más inteligente proporcionándole datos del mundo real. Si lo desea, este servicio accederá a la información de sus registros de errores y de uso, que pueden incluir la información descrita en nuestra ",
    ...
    t65: "Tenga en cuenta que estos complementos no están desarrollados ni mantenidos por IEMAI 3D Slicer. Deben usarse bajo su propia responsabilidad.",
    ...
    t83: "2. Cierre todas las instancias de IEMAI 3D Slicer",
    t84: "3. Elimine todos los archivos del directorio de complementos",
    t85: "4. Vuelva a abrir IEMAI 3D Slicer e instale el complemento de nuevo",
    t86: "Cerrar",
  ...
  it_IT: {
    t1: "Benvenuti in IEMAI 3D Slicer",
    t2: "IEMAI 3D Slicer verrà configurato seguendo diversi passaggi. Cominciamo!",
    t3: "Condizioni d'uso",
    t4: "Non accetto",
    t5: "Accetto",
    ...
    t52: "Salta",
    t53: "Iscriviti",
    t54: "Nella comunità di stampa 3D, impariamo dai successi e dagli insuccessi di ognuno per adattare i nostri parametri e le nostre impostazioni di slicing. IEMAI 3D Slicer segue lo stesso principio, utilizzando l'apprendimento automatico per migliorare le sue prestazioni sfruttando i successi e gli insuccessi delle numerose stampe dei nostri utenti. Stiamo addestrando IEMAI 3D Slicer ad essere più intelligente, fornendogli dati del mondo reale. Se lo desideri, questo servizio accederà alle informazioni dei tuoi registri di errore e di utilizzo, i quali possono includere informazioni descritte in ",
    ...
    t65: "Si prega di notare che questi moduli non sono sviluppati o mantenuti da IEMAI 3D Slicer. Dovrebbero essere utilizzati a proprio rischio e discrezione.",
    ...
    t83: "2, Chiudere tutte le istanze di IEMAI 3D Slicer",
    t84: "3, Eliminare tutti i file all'interno della directory del modulo",
    t85: "4, Riaprire IEMAI 3D Slicer e installare nuovamente il modulo",
    t86: "Chiudi",
    t87: "Manuale d'uso",
    t88: "Rimuovi",
  ...
  de_DE: {
    t1: "Willkommen im IEMAI 3D Slicer",
    t2: "Das IEMAI 3D Slicer wird in mehreren Schritten eingerichtet. Lass uns anfangen!",
    ...
    t52: "Überspringen",
    t53: "Beitreten",
    t54: "In der 3D-Druck-Community lernen wir aus den Erfolgen und Misserfolgen der anderen Benutzer, um unsere eigenen Schneideparameter und Einstellungen anzupassen. IEMAI 3D Slicer folgt demselben Prinzip und verbessert seine Leistung durch die Erfolge und Misserfolge der Vielzahl von Drucken unserer Benutzer mittels maschinellem Lernen. Wir trainieren IEMAI 3D Slicer, indem wir ihnen die realen Daten zuführen. Wenn Sie bereit sind, greift dieser Dienst auf Informationen aus Ihren Fehler- und Nutzungsprotokollen zu, die Informationen enthalten können, die in der ",
    ...
    t83: "2, Schließen Sie alle geöffneten IEMAI 3D Slicer",
    t84: "3, Löschen Sie alle Dateien im Plug-in-Verzeichnis",
    t85: "4, Öffnen Sie IEMAI 3D Slicer erneut und installieren Sie das Plug-in erneut",
    t86: "Schließen",
  ...
  cs_CZ: {
    t1: "Vítejte v IEMAI 3D Slicer",
    t2: "IEMAI 3D Slicer bude nastaven v několika krocích. Začněme!",
    ...
    t52: "Přeskočit",
    t53: "Připojit se",
    t54: "V komunitě 3D tisku se ze vzájemných úspěchů a neúspěchů učíme upravovat vlastní parametry a nastavení krájení. IEMAI 3D Slicer se řídí stejným principem a využívá strojové učení ke zlepšení svého výkonu na základě úspěchů a neúspěchů počet výtisků našimi uživateli. IEMAI 3D Slicer školíme, aby byl chytřejší tím, že jim poskytuje data z reálného světa. Pokud budete chtít, bude tato služba přistupovat k informacím z vašich protokolů chyb a protokolů použití, které mohou zahrnovat informace popsané v ",
    ...
    t83: "2, Zavřete všechny otevřené IEMAI 3D Slicer",
    t84: "3, Smažte všechny soubory v adresáři plug-in",
    t85: "4, znovu otevřete IEMAI 3D Slicer a znovu nainstalujte zásuvný modul",
    t86: "Zavřít",
  ...
  fr_FR: {
    t1: "Bienvenue sur IEMAI 3D Slicer",
    t2: "IEMAI 3D Slicer sera configuré en plusieurs étapes. Commençons !",
    ...
    t52: "Passer",
    t53: "Rejoindre",
    t54: "Dans la communauté de l'impression 3D, nous apprenons des succès et des échecs des uns et des autres pour ajuster nos propres paramètres et paramètres de découpage. IEMAI 3D Slicer suit le même principe et utilise l'apprentissage automatique pour améliorer ses performances à partir des succès et des échecs du grand nombre d'impressions de nos utilisateurs. Nous formons IEMAI 3D Slicer à être plus intelligent en leur fournissant les données du monde réel. Si vous le souhaitez, ce service accédera aux informations de vos journaux d'erreurs et de vos journaux d'utilisation, qui peuvent inclure des informations décrites dans ",
    ...
    t65: "Veuillez noter que ces plugins ne sont pas développés ou maintenus par IEMAI 3D Slicer. Ils doivent être utilisés à votre propre discrétion et à vos propres risques.",
    ...
    t83: "2, Fermez toutes les fenêtres de IEMAI 3D Slicer",
    t84: "3, Supprimez tous les fichiers dans le répertoire du plug-in",
    t85: "4, Relancez IEMAI 3D Slicer et réinstallez le plug-in.",
    t86: "Fermer",
    ...
    wk2: "Cet article présente l'utilisation la plus basique de IEMAI 3D Slicer. Il guide les utilisateurs pour configurer le logiciel, créer des projets et effectuer la première tâche d'impression étape par étape.",
    wk3: "Workflow basé sur des projets",
    wk4: "IEMAI 3D Slicer met en avant un workflow de pointe pour véritablement réaliser un projet « tout en un ». Basé sur le format de projet 3MF grand public, il fournit une série de nouvelles fonctionnalités révolutionnaires, telles que la prise en charge de plusieurs plaques, un gestionnaire de ressources de projet et une vue d'assemblage/de pièce. Cela améliore considérablement l'efficacité des créateurs et des utilisateurs réguliers",
    wk5: "Impression haute vitesse de qualité",
    wk6: "Il est difficile d'imprimer à grande vitesse tout en maintenant une qualité élevée. IEMAI 3D Slicer rend cela possible. « Arch Move » permet à la hotend de se déplacer en douceur et réduit les vibrations de la machine. Le refroidissement intelligent est basé sur des paramètres de refroidissement affinés pour chaque type de filament. Le « ralentissement automatique » pour les paroies en porte-à-faux permet d'éviter la déformation à grande vitesse.",
    wk7: "Impression multi-couleur",
    wk8: "IEMAI 3D Slicer fournit des outils de colorisation polyvalents pour créer un modèle coloré. Vous pouvez librement ajouter/supprimer des filaments dans un projet et coloriser votre modèle avec différents pinceaux. Avant l'impression, chaque filament sera automatiquement mappé sur un emplacement AMS, sans avoir besoin de modifier manuellement le placement de la bobine dans l'AMS.",
    wk9: "Guide de réglage des paramètres de découpage",
    wk10: "Les fonctionnalités de gestion des paramètres de IEMAI 3D Slicer offrent un contrôle très flexible et puissant sur le processus de découpage. Cet article présente l'organisation des paramètres et fournit quelques compétences pour tirer pleinement parti de ces fonctionnalités.",
    wk11: "Contrôle et surveillance à distance",
    wk12: "IEMAI 3D Slicer prend en charge l'envoi du travail d'impression à votre imprimante via le réseau WAN/LAN, contrôlant et surveillant chaque aspect de votre imprimante 3D et des travaux d'impression. Si vous avez plusieurs imprimantes, vous pouvez facilement basculer entre elles dans la liste des périphériques.",
    wk13: "Format STEP",
    ...
    wk15: "Texte 3D",
    wk16: "Avec l'outil Texte 3D, les utilisateurs peuvent facilement créer diverses formes de texte 3D dans le projet, ce qui rend le modèle plus personnalisé. IEMAI 3D Slicer fournit des dizaines de polices et prend en charge les styles gras et italique pour donner au texte une plus grande flexibilité.",
    orca6: "Bambu Cloud",
    orca7: "Orca Cloud Account",
    orca8: "Not signed in",
    orca9: "Bambu Cloud Account",
  ...
  zh_CN: {
    t1: "欢迎使用IEMAI 3D Slicer",
    t2: "IEMAI 3D Slicer需要几步安装步骤，让我们开始吧！",
    t3: "用户使用协议",
    t4: "拒绝",
    t5: "同意",
    t6: "帮助提升IEMAI 3D Slicer性能",
    t7: "允许发送匿名数据",
    t8: "上一步",
    t9: "下一步",
    t10: "选择打印机",
    ...
    t52: "忽略",
    t53: "同意",
    t54: "在3D打印社区，我们从彼此的成功和失败中学习调整自己的切片参数和设置。IEMAI 3D Slicer遵循同样的原则，通过机器学习的方式从大量用户打印的成功和失败中获取经验，从而改善打印性能。我们正在通过向IEMAI 3D Slicer提供真实世界的数据来训练他们变得更聪明。如果您愿意，此服务将访问您的错误日志和使用日志中的信息，其中可能包括",
    t55: "隐私政策",
    ...
    t64: "Bambu网络插件",
    t65: "注意：这些插件不是由IEMAI 3D Slicer开发或维护的。使用它们需自担风险",
    t66: "强大的远程控制功能",
    t67: "实时视频流",
    t68: "用户数据同步",
    t69: "安装Bambu网络插件",
    ...
    t81: "1, 点击",
    t82: "打开插件所在目录",
    t83: "2, 关闭所有IEMAI 3D Slicer",
    t84: "3, 删除插件所在目录下的所有文件",
    t85: "4, 重新启动IEMAI 3D Slicer并尝试安装插件",
    t86: "关闭",
    t87: "使用引导",
    t88: "移除",
    t89: "打开所在的文件夹",
    ...
    t126: "正在加载……",
    wk1: "快速入门指南",
    wk2: "本文介绍了IEMAI 3D Slicer的最基本用法。它指导用户配置软件，创建项目，并逐步完成第一个打印任务。",
    wk3: "基于项目的工作流",
    wk4: "IEMAI 3D Slicer提出了领先的工作流程，真正实现了“一体化”项目。基于主流的3MF项目格式，它提供了一系列革命性的新功能，如支持多盘、项目资源管理器和装配/零件视图。它可以大幅提高模型创作者及普通用户的使用效率。",
    wk5: "质量卓越的高速打印",
    wk6: "在保持高质量的前提下进行高速打印是非常具有挑战性的。IEMAI 3D Slicer让这一切发生。支持“圆弧移动”特性使工具头移动更加顺滑，有效减少机器振动。基于不同材料类型的精细标定过的冷却控制参数，使得冷却过程可以自动开展。在悬垂区域进行“自动减速”，可防止高速打印时在此区域的外观瑕疵。",
    wk7: "多色打印",
    wk8: "IEMAI 3D Slicer提供了多种着色工具来制作彩色模型。您可以在项目中自由添加/移除打印材料，并使用不同的笔刷为模型着色。开始打印时，打印任务中的各个材料将自动映射到匹配的AMS槽位，无需手动调整AMS中的料卷位置。",
    wk9: "切片参数设置指南",
    wk10: "IEMAI 3D Slicer中的参数管理功能为切片过程提供了非常灵活和强大的控制。本文介绍了切片参数的组织分类和设置方法，并提供了一些使用技巧。",
    wk11: "远程控制和监控",
    wk12: "IEMAI 3D Slicer支持通过WAN/LAN网络向打印机发送打印任务，控制和查看3D打印机和打印任务的各个方面。如果您有多台打印机，还可以在设备列表中轻松切换。",
    wk13: "STEP格式",
    wk14: "与STL相比，STEP带来了更多有效的信息。由于STEP的高精度，切片时可以生成更多的圆弧路径。STEP还包括模型每个零件的装配关系，可分割模型后恢复装配视图。",
    wk15: "3D文本",
    wk16: "使用3D文本工具，用户可以轻松地在项目中创建各种3D文本形状，使模型更加个性化。IEMAI 3D Slicer提供了数十种字体，并支持粗体和斜体样式，使文本具有更大的灵活性。",
    orca1: "编辑项目信息",
    orca2: "该模型没有相关信息",
    orca6: "Bambu Cloud",
    orca7: "Orca Cloud Account",
  ...
  zh_TW: {
    t1: "歡迎使用 IEMAI 3D Slicer",
    t2: "IEMAI 3D Slicer 需要幾步安裝步驟，讓我們開始吧！",
    t3: "使用者協議",
    t4: "拒絕",
    t5: "同意",
    t6: "幫助提升 IEMAI 3D Slicer 性能",
    t7: "允許傳送匿名數據",
    t8: "上一步",
    t9: "下一步",
    t10: "選擇３Ｄ列印機",
    ...
    t52: "忽略",
    t53: "同意",
    t54: "在3D列印社區，我們從彼此的成功和失敗中學習調整自己的切片參數和設置。IEMAI 3D Slicer 遵循同樣的原則，透過機器學習的方式從大量用戶列印的成功和失敗中獲取經驗，從而改善列印性能。我們正在通過向 IEMAI 3D Slicer 提供真實世界的數據來訓練他們變得更聰明。如果您願意，此服務將訪問您的錯誤日誌和使用日誌中的資訊，其中可能包括",
    t55: "隱私政策",
    ...
    t81: "1, 點擊",
    t82: "打開插件所在目錄",
    t83: "2, 關閉所有 IEMAI 3D Slicer",
    t84: "3, 刪除插件所在目錄下的所有文件",
    t85: "4, 重新啟動 IEMAI 3D Slicer 並嘗試安裝插件",
    t86: "關閉",
    t87: "使用引導",
    t88: "移除",
    t89: "打開所在的文件夾",
    ...
    t92: "Bambu聖誕小屋",
    wk1: "快速入門指南",
    wk2: "本文介紹了 IEMAI 3D Slicer 的最基本用法。它指導用戶配置軟體，創建項目，並逐步完成第一個列印任務。",
    wk3: "基於項目的工作流",
    wk4: "IEMAI 3D Slicer 提出了領先的工作流程，真正實現了“一體化”項目。基於主流的3MF項目格式，它提供了一系列革命性的新功能，如支持多盤、項目資源管理器和裝配/零件視圖。它可以大幅提高模型創作者及普通用戶的使用效率。",
    wk5: "質量卓越的高速列印",
    wk6: "在保持高品質的前提下進行高速列印是非常具有挑戰性的。IEMAI 3D Slicer 讓這一切發生。支持“圓弧移動”特性使工具頭移動更加順滑，有效減少機器振動。基於不同線材類型的精細標定過的冷卻控制參數，使得冷卻過程可以自動開展。在懸垂區域進行“自動減速”，可防止高速列印時在此區域的外觀瑕疵。",
    wk7: "多色列印",
    wk8: "IEMAI 3D Slicer 提供了多種著色工具來製作彩色模型。您可以在項目中自由添加/移除列印材料，並使用不同的筆刷為模型著色。開始列印時，列印任務中的各個線材將自動映射對應到 AMS 槽位，無需手動調整 AMS 中的線材位置。",
    wk9: "切片參數設置指南",
    wk10: "IEMAI 3D Slicer 中的參數管理功能為切片過程提供了非常靈活和強大的控制。本文介紹了切片參數的組織分類和設置方法，並提供了一些使用技巧。",
    wk11: "遠端控制和監控",
    wk12: "IEMAI 3D Slicer 支持透過無線網路/區域網路向３Ｄ列印機發送列印任務，控制和查看３Ｄ列印機和列印任務的各個方面。如果您有多台３Ｄ列印機，還可以在設備清單中輕鬆切換。",
    wk13: "STEP格式",
    wk14: "與 STL 相比，STEP 帶來了更多有效的資訊。由於 STEP 的高精度，切片時可以生成更多的圓弧路徑。STEP 還包括模型每個零件的組裝關係，可分割模型後恢復裝配視圖。",
    wk15: "３Ｄ文本",
    wk16: "使用３Ｄ文字工具，使用者可以輕鬆地在項目中建立各種３Ｄ文字形狀，使模型更加個性化。IEMAI 3D Slicer 提供了數十種字體，並支援粗體和斜體樣式，使文字具有更大的靈活性。",
    orca1: "編輯專案資訊",
    orca2: "沒有模型相關資訊",
    orca6: "Bambu Cloud",
    orca7: "Orca Cloud Account",
  ...
  ru_RU: {
    t1: "Приветствуем в IEMAI 3D Slicer!",
    t2: "Для настройки IEMAI 3D Slicer необходимо пройти несколько этапов. Давайте начнём!",
    ...
    t52: "Пропустить",
    t53: "Войти",
    t54: "Для поиска наилучших параметров нарезки и улучшения печати участники сообщества 3D-печати учатся на успехах и неудачах друг друга. IEMAI 3D Slicer следует тому же принципу и использует машинное обучение для улучшения своей работы на основе успешного и неудачного опыта печати наших пользователей. Мы обучаем IEMAI 3D Slicer быть умнее на основе реальных данных. По вашему согласию эта служба получит доступ к вашим журналам ошибок и журналам использования, в которых содержатся сведения, описанные в ",
    ...
    t65: "Имейте в виду, что эти плагины не разрабатываются и не поддерживаются IEMAI 3D Slicer. Используйте их на свой страх и риск.",
    ...
    t83: "2, Закройте все окна IEMAI 3D Slicer",
    t84: "3, Удалите все файлы в папке плагина",
    t85: "4, Откройте IEMAI 3D Slicer и снова установите плагин.",
    t86: "Закрыть",
    t87: "Инструкции",
    t88: "Удалить",
  ...
  ko_KR: {
    t1: "IEMAI 3D Slicer에 오신 것을 환영합니다",
    t2: "IEMAI 3D Slicer는 여러 단계로 설정됩니다. 시작!",
    t3: "사용자 약관",
    t4: "거부",
    t5: "동의",
    ...
    t52: "건너뛰기",
    t53: "가입",
    t54: "3D 프린팅 커뮤니티에서 우리는 각자의 슬라이싱 매개변수와 설정을 조정하는 과정에서 서로의 성공과 실패를 통해 배웁니다. IEMAI 3D Slicer는 동일한 원칙을 따르며 기계 학습을 사용하여 사용자의 방대한 출력물의 성공과 실패를 통해 성능을 향상시킵니다. 우리는 실제 데이터를 제공하여 IEMAI 3D Slicer가 더욱 똑똑해지도록 교육하고 있습니다. 귀하가 원할 경우 이 서비스는 오류 로그 및 사용 로그의 정보에 액세스합니다. 여기에는 다음에 설명된 정보가 포함될 수 있습니다.",
    t55: "개인 정보 정책",
    ...
    t83: "2, 열려 있는 모든 IEMAI 3D Slicer를 닫습니다.",
    t84: "3, 플러그인 디렉터리 아래의 모든 파일 삭제합니다",
    t85: "4, IEMAI 3D Slicer를 다시 열고 플러그인을 다시 설치하세요.",
    t86: "닫기",
    t87: "사용자 메뉴얼",
    t88: "제거",
    t89: "포함된 폴더 열기",
  ...
  tr_TR: {
    t1: "IEMAI 3D Slicer'a hoş geldiniz",
    ...
    t52: "Atla",
    t53: "Katıl",
    t54: "3D Baskı topluluğunda, kendi dilimleme parametrelerimizi ve ayarlarımızı düzenlerken birbirimizin başarılarından ve başarısızlıklarından öğreniyoruz. IEMAI 3D Slicer da aynı prensibi takip ediyor ve kullanıcılarımızın yaptığı çok sayıda baskının başarı ve başarısızlıklarından performansını artırmak için makine öğrenimini kullanıyor. IEMAI 3D Slicer'ı gerçek dünya verileriyle besleyerek daha akıllı olması için eğitiyoruz. İsterseniz bu hizmet, hata günlüklerinizden ve kullanım günlüklerinizden, burada açıklanan bilgileri de içerebilecek bilgilere erişecektir. ",
    ...
    t65: "Lütfen bu eklentilerin IEMAI 3D Slicer tarafından geliştirilmediğini veya bakımının yapılmadığını unutmayın. Kendi takdirinize ve riskinize göre kullanılmalıdırlar.",
    ...
    t83: "2, Tüm açık IEMAI 3D Slicerı kapatın",
    t84: "3, Eklenti dizini altındaki tüm dosyaları silin",
    t85: "4, IEMAI 3D Slicer'ı yeniden açın ve eklentiyi tekrar yükleyin",
    t86: "Kapat",
  ...
  pl_PL: {
    t1: "Witamy w IEMAI 3D Slicer",
    t2: "IEMAI 3D Slicer zostanie skonfigurowany w kilku krokach. Zacznijmy!",
    ...
    t52: "Pomiń",
    t53: "Dołącz",
    t54: "W społeczności druku 3D uczymy się od sukcesów i porażek innych, aby dostosować nasze własne parametry i ustawienia krojenia. IEMAI 3D Slicer podąża tą samą zasadą i wykorzystuje uczenie maszynowe do poprawy swojej wydajności na podstawie sukcesów i porażek dużej liczby wydruków naszych użytkowników. Szkolimy IEMAI 3D Slicer, aby był mądrzejszy, dostarczając mu danych z rzeczywistego świata. Jeśli chcesz, ta usługa uzyska dostęp do informacji z Twoich logów błędów i logów użytkowania, które mogą zawierać informacje opisane w ",
    ...
    t65: "Proszę mieć świadomość, że te wtyczki nie są rozwijane ani utrzymywane przez IEMAI 3D Slicer. Powinny być używane na własne ryzyko i z rozwagą.",
    ...
    t83: "2, Zamknij wszystkie otwarte IEMAI 3D Slicer",
    t84: "3, Usuń wszystkie pliki z katalogu wtyczek",
    t85: "4, Ponownie otwórz IEMAI 3D Slicer i zainstaluj wtyczkę ponownie",
    t86: "Zamknij",
  ...
  pt_BR: {
    t1: "Bem-vindo ao IEMAI 3D Slicer",
    t2: "IEMAI 3D Slicer será configurado em várias etapas. Vamos começar!",
    t3: "Termos de Uso",
    t4: "Discordo",
    t5: "Concordo",
    ...
    t65: "Por favor seja cuidadoso estes plugins não são desenvolvidos ou mantidos por IEMAI 3D Slicer. Eles devem ser usados por sua conta e risco.",
    ...
    t83: "2, Feche totalmente o IEMAI 3D Slicer",
    t84: "3, Delete todos os arquivos na pasta do plug-in",
    t85: "4, Reabra o IEMAI 3D Slicer e instale o plug-in novamente",
    t86: "Fechar",
  ...
  lt_LT: {
    t1: "Pasisveikinkite su IEMAI 3D Slicer",
    t2: "IEMAI 3D Slicer bus nustatyta per kelis žingsnius. Pradėkime!",
    ...
    t52: "Praleisti",
    t53: "Prisijungti",
    t54: "3D spausdinimo bendruomenėje mokomės vieni iš kitų sėkmių ir nesėkmių, kad galėtume pritaikyti savo pjaustymo parametrus ir nustatymus. IEMAI 3D Slicer vadovaujasi tuo pačiu principu ir naudoja mašininį mokymąsi, kad pagerintų savo veikimą, remdamasi daugybės mūsų naudotojų atspaudų sėkmėmis ir nesėkmėmis. Maitindami IEMAI 3D Slicer realaus pasaulio duomenimis, mokome ją būti protingesne. Jei pageidaujate, ši paslauga pasieks informaciją iš jūsų klaidų žurnalų ir naudojimo žurnalų, į kuriuos gali būti įtraukta informacija, aprašyta ",
    ...
    t65: "Atkreipkite dėmesį, kad IEMAI 3D Slicer šių papildinių nesukuria ir neprižiūri. Juos turėtumėte naudoti savo nuožiūra ir rizika.",
    ...
    t83: "2, Uždarykite visas veikiančias IEMAI 3D Slicer programas",
    t84: "3, Ištrinkite visus failus iš papildinių katalogo",
    t85: "4, Iš naujo atverkite IEMAI 3D Slicer ir iš naujo įdiekite papildinį",
    t86: "Užverti",
