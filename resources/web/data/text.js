var LangText = {
  ...
  es_ES: {
    ...
    t2: "OrcaSlicer se configurará mediante varios pasos. ¡Comencemos!",
    t3: "Términos de uso",
    t4: "No acepto",
    t5: "Acepto",
    ...
    t83: "2. Cierre todas las instancias de OrcaSlicer",
    t84: "3. Elimine todos los archivos del directorio de complementos",
    t85: "4. Vuelva a abrir OrcaSlicer e instale el complemento de nuevo",
    t86: "Cerrar",
  ...
  ru_RU: {
    ...
    t2: "Для настройки OrcaSlicer необходимо пройти несколько этапов. Давайте начнём!",
    ...
    t52: "Пропустить",
    t53: "Войти",
    t54: "Для поиска наилучших параметров нарезки и улучшения печати участники сообщества 3D-печати учатся на успехах и неудачах друг друга. OrcaSlicer следует тому же принципу и использует машинное обучение для улучшения своей работы на основе успешного и неудачного опыта печати наших пользователей. Мы обучаем OrcaSlicer быть умнее на основе реальных данных. По вашему согласию эта служба получит доступ к вашим журналам ошибок и журналам использования, в которых содержатся сведения, описанные в ",
    ...
    t83: "2, Закройте все окна OrcaSlicer",
    t84: "3, Удалите все файлы в папке плагина",
    t85: "4, Откройте OrcaSlicer и снова установите плагин.",
    t86: "Закрыть",
    t87: "Инструкции",
    t88: "Удалить",
