...
#include <slic3r/GUI/Widgets/AuiPaneLayout.hpp>
...
TEST_CASE("A reloaded plugin page is recognised by its base URL, fragment aside", "[PluginHost]")
{
    ...
    // What a plugin page reports after the host swapped it in, and after the page moved to an
    // anchor within it and the user reloaded.
